...
class ProductListBuilderTest extends TestCase
{
    ...
    public function test_builds_first_page(): void
    {
        ...
        $products = [
            new Product('25cc9f5d-7702-4cb0-b6fc-f93b049055ca', 'Product 1', 1200, $createdAt),
            new Product('30e4e028-3b38-4cb9-9267-a9e515983337', 'Product 2', 1400, $createdAt),
            new Product('f6635017-982f-4544-9ac5-3d57107c0f0d', 'Product 3', 1500, $createdAt),
        ];
        ...
        $this->assertEquals([
            ...
            'count' => 5,
            'products' => [
                ['id' => '25cc9f5d-7702-4cb0-b6fc-f93b049055ca', 'name' => 'Product 1', 'price' => 1200, 'createdAt' => '2025-06-21 12:00:00'],
                ['id' => '30e4e028-3b38-4cb9-9267-a9e515983337', 'name' => 'Product 2', 'price' => 1400, 'createdAt' => '2025-06-21 12:00:00'],
                ['id' => 'f6635017-982f-4544-9ac5-3d57107c0f0d', 'name' => 'Product 3', 'price' => 1500, 'createdAt' => '2025-06-21 12:00:00'],
            ],
