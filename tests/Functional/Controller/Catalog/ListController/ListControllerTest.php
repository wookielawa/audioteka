        ...
        self::assertEquals([
            ...
            'products' => [
                [
                    ...
                    'name' => 'Product 7',
                    'price' => 8990,
                    'createdAt' => '2025-06-21 12:06:00'
                ],
                [
                    'id' => 'e41ac303-11ab-446e-a253-28572278fdbe',
                    'name' => 'Product 6',
                    'price' => 7990,
                    'createdAt' => '2025-06-21 12:05:00'
                ],
                [
                    'id' => '0a5d83f1-8c7e-4253-b020-156439f3d3c9',
                    'name' => 'Product 5',
                    'price' => 6990,
                    'createdAt' => '2025-06-21 12:04:00'
                ],
            ]
        ], $response);
    }
        ...
        self::assertEquals([
            ...
            'products' => [
                [
                    ...
                    'name' => 'Product 4',
                    'price' => 5990,
                    'createdAt' => '2025-06-21 12:03:00'
                ],
                [
                    'id' => '15e4a636-ef98-445b-86df-46e1cc0e10b5',
                    'name' => 'Product 3',
                    'price' => 4990,
                    'createdAt' => '2025-06-21 12:02:00'
                ],
                [
                    'id' => '9670ea5b-d940-4593-a2ac-4589be784203',
                    'name' => 'Product 2',
                    'price' => 3990,
                    'createdAt' => '2025-06-21 12:01:00'
                ],
            ]
        ], $response);
    }
